...
# Тест-кейси:
#1. Запускаємо з percent=0 . Перевіряємо як відпрацьовує функція, коли percent=0 (початок шкали відсотків)
#2. Запускаємо з percent=100. Перевыряємо як відпрацьовують строки 25...29, коли percent=100 (кінець шкали відсотків)
